...
/* Private defines -----------------------------------------------------------*/
#define LED_STAT_1_Pin LL_GPIO_PIN_6
#define LED_STAT_1_GPIO_Port GPIOF
#define LED_STAT_2_Pin LL_GPIO_PIN_7
#define LED_STAT_2_GPIO_Port GPIOF
#define SOFT_SPI_MOSI_Pin LL_GPIO_PIN_3
